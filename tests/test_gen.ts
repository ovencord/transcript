import { type ChannelInfo, createTranscript, type Message } from '../src/index.ts';
...
const messages: Message[] = [
	...
	},
	{
		...
		separators: [{ divider: true, spacing: 3 }],
		reactions: [],
	},
	{
		id: '7',
		...
		components: [
			{
				...
				components: [
					...
					{
						type: 1,
						components: [{ type: 2, style: 1, label: 'Button Inside', customId: 'btn_in' }],
					},
				],
			},
